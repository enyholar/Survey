...
public class QCustom2Fragment extends Fragment {
  private Button button_continue,button_previous;
  private TextView textview_q_title;
  private EditText editText_answer;

  public QCustom2Fragment() {
    // Required empty public constructor
  }

  public static QCustom2Fragment newInstance(String param1, String param2) {
    QCustom2Fragment fragment = new QCustom2Fragment();
...
//    fragment.setArguments(args);
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container,
    ...
    ViewGroup rootView = (ViewGroup) inflater.inflate(
        R.layout.fragment_qicustom2, container, false);
    ...
    showInputMethod();
    textview_q_title.setText(getContext().getResources().getString(R.string.q_custom2));
    button_continue.setOnClickListener(new View.OnClickListener() {
      @Override public void onClick(View v) {
        custom2 = editText_answer.getText().toString();
        preferenUtil.savedata("c2",editText_answer.getText().toString());
//        if (!custom2.isEmpty()){
