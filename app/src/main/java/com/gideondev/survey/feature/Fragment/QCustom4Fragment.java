...
public class QCustom4Fragment extends Fragment {
  private Button button_continue,button_previous;
  private TextView textview_q_title;
  private EditText editText_answer;

  public QCustom4Fragment() {
    // Required empty public constructor
  }

  public static QCustom4Fragment newInstance(String param1, String param2) {
    QCustom4Fragment fragment = new QCustom4Fragment();
...
//    fragment.setArguments(args);
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container,
    ...
    ViewGroup rootView = (ViewGroup) inflater.inflate(
        R.layout.fragment_qicustom4, container, false);
    ...
    showInputMethod();
    textview_q_title.setText(getContext().getResources().getString(R.string.q_custom4));
    button_continue.setOnClickListener(new View.OnClickListener() {
      @Override public void onClick(View v) {
        custom4 = editText_answer.getText().toString();
        preferenUtil.savedata("c4",editText_answer.getText().toString());
//        if (!custom4.isEmpty()){
