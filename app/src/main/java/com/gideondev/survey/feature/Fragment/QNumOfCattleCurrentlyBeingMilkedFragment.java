...
public class QNumOfCattleCurrentlyBeingMilkedFragment extends Fragment {
  private Button button_continue,button_previous;
  private TextView textview_q_title;
  private EditText editText_answer;

  public QNumOfCattleCurrentlyBeingMilkedFragment() {
    // Required empty public constructor
  }

  public static QNumOfCattleCurrentlyBeingMilkedFragment newInstance(String param1, String param2) {
    QNumOfCattleCurrentlyBeingMilkedFragment fragment = new QNumOfCattleCurrentlyBeingMilkedFragment();
...
//    fragment.setArguments(args);
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container,
    ...
    ViewGroup rootView = (ViewGroup) inflater.inflate(
        R.layout.fragment_qnume_of_cattle_currently_milked, container, false);
    ...
    showInputMethod();
    textview_q_title.setText(getContext().getResources().getString(R.string.q_num_cattle_currently_milked));
    button_continue.setOnClickListener(new View.OnClickListener() {
      @Override public void onClick(View v) {
        numOfCattleMilked = editText_answer.getText().toString().trim();
        if (numOfCattleMilked != null && !numOfCattleMilked.isEmpty()){
          preferenUtil.savedata("cmilk",editText_answer.getText().toString().trim());
