...
public class QCustom1Fragment extends Fragment {
  private Button button_continue,button_previous;
  private TextView textview_q_title;
  private EditText editText_answer;

  public QCustom1Fragment() {
    // Required empty public constructor
  }

  public static QCustom1Fragment newInstance(String param1, String param2) {
    QCustom1Fragment fragment = new QCustom1Fragment();
...
//    fragment.setArguments(args);
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container,
    ...
    ViewGroup rootView = (ViewGroup) inflater.inflate(
        R.layout.fragment_qicustom1, container, false);
    ...
    showInputMethod();
    textview_q_title.setText(getContext().getResources().getString(R.string.q_custom1));
    button_continue.setOnClickListener(new View.OnClickListener() {
      @Override public void onClick(View v) {
        custom1 = editText_answer.getText().toString();
        preferenUtil.savedata("c1",editText_answer.getText().toString());
 //       if (!custom1.isEmpty()){
